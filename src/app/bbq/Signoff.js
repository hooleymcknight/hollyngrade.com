...
export default function Signoff() {
  return (
    <svg className="signoff-art" viewBox="0 0 600 400" role="img" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="tx-stars" fill="#9CC3D8" stroke="#1F4E66">
      ...
      {/* ===== the sticker ===== */}
      {/* Overlaps the southwest border on purpose -- a sticker that touches
          nothing reads as a second card rather than something stuck on. */}
      <g transform="rotate(-4 316 306)">
        <rect x="199" y="239" width="240" height="140" rx="2" fill="#0F0C0A" fillOpacity="0.12" />
        <rect x="196" y="236" width="240" height="140" rx="2" fill="#FFFFFF" stroke="#D8CFBC" strokeWidth="0.75" />

        <rect x="210" y="250" width="92" height="18" rx="3" fill="#1E1A17" />
        <text
          x="256" y="263" textAnchor="middle" fill="#FFFFFF"
          fontFamily="'Oswald',sans-serif" fontSize="9.5" fontWeight="600" letterSpacing="0.9"
        >
          HOLLYN&rsquo;S
        </text>
        <text
          x="310" y="264" fill="#1E1A17"
        ...
        <text
          x="316" y="288" textAnchor="middle" fill="#1E1A17"
        ...
        <g fontFamily="ui-monospace,'Courier New',monospace" fontSize="8" fill="#3D3730">
          <text x="210" y="308">Quantity:&nbsp; 1 party</text>
          <text x="210" y="321">Packed on: 08.22.26</text>
          <text x="210" y="334">Sell by:&nbsp;&nbsp; same day</text>
        </g>

        <text
          x="422" y="329" textAnchor="end" fill="#1E1A17"
          fontFamily="'Oswald',sans-serif" fontSize="27" fontWeight="600"
        >
          $0.00
        </text>

        <line x1="210" y1="346" x2="422" y2="346" stroke="#D8CFBC" strokeWidth="0.75" />
        <text
          x="316" y="361" textAnchor="middle" fill="#3D3730"
