...
export default function Upload() {
            ...
            try {
                ...
                if (!result.success) {
                    ...
                    fetch('https://ntfy.sh/chasm_story_hollyn', {
                        ...
                        body: `${bodyMessage}`,
                        headers: {
                            'Title': 'Koda + Chasm memory submission received',
                            // 'Priority': 'normal',
                            'Tags': 'dog,heart'
                        }
                    })
    ...
    return (
        <main className="flex flex-col min-h-screen items-center justify-center">
            ...
            >
                <BackButton target='./' />
                <h1 className="text-4xl mt-6 mb-8 text-center block w-full tracking-tighter">Share Your Memories of Koda & Chasm</h1>
                ...
                >
                    ...
                    <textarea id="story" onFocus={resetMessages} name="story" rows="8" //cols="40"
                        ...
                        placeholder={'Your favorite memory of Koda & Chasm'} 
                    />
